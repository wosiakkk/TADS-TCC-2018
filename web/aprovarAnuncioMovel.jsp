...
<div class="col-8 menu-fixed-center">
    <div class="panel panel-body">
        ...
        <div class="jumbotron col-sm-12" >
            <c:set var="lista" value="${listaMovelPendente}"/>
            <c:forEach var="lista" items="${listaMovelPendente}">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="AnuncioServlet?action=BUSCARPORIDMOVEL&id=${lista.id}" class="btn btn-primary">Verificar</a>
                    </div>
                </div>
            </c:forEach>
        </div>
