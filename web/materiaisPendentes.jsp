...
<div class="container">       
    <div class="row">
        ...
        <div class="col-lg-9">
            <h2>Avaliação do Anúncio de ID: ${matBuscado.id} </h2>
            ...
            <div class="card mt-4">
                <div id="demo" class="carousel slide" data-ride="carousel">
                    ...
                    <ul class="carousel-indicators">
                        <c:forEach var="foto" items="${matBuscado.fotos}" varStatus="j">
                            <c:choose>
                    ...
                    <div class="carousel-inner">
                        <c:forEach var="foto" items="${matBuscado.fotos}" varStatus="i">
                            <c:choose>
                ...
                <div class="card-body">
                    <h3 class="card-title">${matBuscado.titulo}</h3>
                    <h4><fmt:formatNumber value="${matBuscado.preco}" type="currency"/></h4>
                    <p class="card-text"> ${matBuscado.descricao}
                        <br><label>Tipo de Material:</label> ${matBuscado.tipoDesc}                      
                        <br><label>Logradouro: </label> ${matBuscado.rua}
                        <br><label>Número: </label> ${matBuscado.numero}
                        <br><label>CEP: </label> ${matBuscado.cep}
                        <br><label>Cidade: </label> ${matBuscado.cidade}
                        <br><label>Estado: </label> ${matBuscado.estado}
                        <br><label>Complemento: </label> ${matBuscado.complemento}
                    </p>                       
                </div>
            </div>
            <hr>
            <form class="form-horizontal"  action="AnuncioServlet?action=APROVAR&id=${matBuscado.id}"  method="POST" role="form">
