            ...
            <div class="card mt-4">
                <div id="demo" class="carousel slide" data-ride="carousel">
                    ...
                    <ul class="carousel-indicators">
                        <c:forEach var="foto" items="${imovelBuscado.fotos}" varStatus="j">
                            <c:choose>
                    ...
                    <div class="carousel-inner">
                        <c:forEach var="foto" items="${imovelBuscado.fotos}" varStatus="i">
                            <c:choose>
                ...
                <div class="card-body">
                    <h3 class="card-title">${imovelBuscado.titulo}</h3>
                    <h4><fmt:formatNumber value="${imovelBuscado.preco}" type="currency"/></h4>
                    <p class="card-text"> ${imovelBuscador.descricao}
                        <br><label>Tipo Imovel:</label> ${imovelBuscado.tipoDesc}
                        <br><label>Quantidade de pessoas:</label> ${imovelBuscado.quantidade_pessoas}
                        ...
                        <br><label>Logradouro: </label> ${imovelBuscado.rua}
                        <br><label>Número: </label> ${imovelBuscado.numero}
                        <br><label>CEP: </label> ${imovelBuscado.cep}
                        <br><label>Cidade: </label> ${imovelBuscado.cidade}
                        <br><label>Estado: </label> ${imovelBuscado.estado}
                        <br><label>Complemento: </label> ${imovelBuscado.complemento}
                    </p>                       
                </div>
            </div>
            <hr>
            <form class="form-horizontal"  action="AnuncioServlet?action=APROVAR&id=${imovelBuscado.id}"  method="POST" role="form">
